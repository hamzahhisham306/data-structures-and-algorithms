...
const validateEmail = (email) => {
  // Solution code here...
  return /\w+@\w+.(com$|net$|org$)/g.test(email);
};
...
const findTagNames = elements => {
  // Solution code here...
  let joinel=elements.join('');
    return joinel.match(/\/(\w+)/g);
};
...
describe('Testing challenge 6', () => {
  ...
  test('It should not match unacceptable phone number formats', () => {
    ...
    expect(validatePhoneNumber('(222 222-2222')).toBeTruthy();
